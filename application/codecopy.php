    ...
    <div class="app-sidebar__inner">
        <ul class="vertical-nav-menu">
            ...
            <li>
                ...
                <ul>
                    <li>
                        <a href="<?php echo base_url('index.php/welcome/userlist') ?>">
                            <i class="metismenu-icon"></i> User List
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url('index.php/welcome/addUser') ?>">
            ...
            <li>
                ...
                <ul>
                    <li>
                        <a href="<?php echo basename('index.php/welcome/cashlist') ?>">
                            <i class="metismenu-icon"></i> Total
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url('index.php/welcome/addCash') ?>">
            ...
            <li>
                <a href="#">
                    <i class="metismenu-icon pe-7s-profile"></i>Profile
                </a>
            </li>
            <li class="mm-active">
                <a href="#">
                                ...
                                <div class="col-sm-6 col-md-6 col-xl-6">
                                    <div class="card no-shadow rm-border bg-transparent widget-chart text-left">
                                        ...
                                        <div class="widget-chart-content">
                                            <div class="widget-subheading">Cash </div>
                                                    ...
                                                    <li class="list-group-item">
                                                        ...
                                                        <div class="widget-content p-0">
                                                            <div class="widget-content-wrapper">
                                                                ...
                                                                <div class="widget-content-left mr-3">
                                                                    <div class="widget-content-left">
                                                                        <img width="42" class="rounded" src="<?= base_url() ?>assets/css/images/avatars/1.jpg" alt>
                                                                    </div>
                                                                </div>
                                                                <div class="widget-content-left">
                                                        ...
                                                        <div>
                                                            <div class="avatar-icon-wrapper mr-1">
                                                                ...
                                                                <div class="avatar-icon avatar-icon-lg rounded">
                                                                    <img src="<?= base_url() ?>assets/css/images/avatars/2.jpg" alt>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div>
                                                        ...
                                                        <div class="chat-box-wrapper chat-box-wrapper-right">
                                                            ...
                                                            <div>
                                                                <div class="avatar-icon-wrapper ml-1">
                                                                    ...
                                                                    <div class="avatar-icon avatar-icon-lg rounded">
                                                                        <img src="<?= base_url() ?>assets/css/images/avatars/3.jpg" alt>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
